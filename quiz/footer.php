                ...
                <div class = "col-lg-4" align = "center">
                  ...
                  <div class= "well well-lg" style = "margin-top: 5px"> 
                   ...
                   <hr style = "margin-top: 5px; margin-bottom: 5px; opacity: 0.5" width = "30%">
                    ...
                    <br> Follow us on <a href = "#" style = "color: #ffffff;"><u>Twitter</u></a>
                  --></div>
                </div>

                <div class = "col-lg-4" align = "center">
                  <em>Wanna give a feedback?</em>
                  <div class= "well well-lg" style = "margin-top: 5px"> 
                   <!--Any queries regarding Physics-Easily...or us?
                   <br>-->
                   Enter it in here: 
                   <h4 style = "font-color: #18bc9c; font-size: 17px"><textarea class = "form-control" rows="3" style = "resize:none"></textarea></h4>
