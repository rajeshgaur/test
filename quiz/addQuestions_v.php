...
if(isset($_POST['desc'])){
	...
	$sql = mysql_query("INSERT INTO questions_v (question, type) VALUES ('$question', '$type')")or die(mysql_error());
		$lastId = mysql_insert_id();
		mysql_query("UPDATE questions_v SET question_id='$lastId' WHERE id='$lastId' LIMIT 1")or die(mysql_error());
	...
	if($type == 'tf'){
		...
		$sql2 = mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
	  ...
	  header('location: addQuestions_v.php?msg='.$msg.'');
	exit();
	}
	if($isCorrect == "answer2"){
		$sql2 = mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer2', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysql_error());
	...
	if($type == 'mc'){
		...
		$sql2 = mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer3', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer4', '0')")or die(mysql_error());
		$sqlq2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer2', '0')")or die(mysql_error());
	...
	if($isCorrect == "answer3"){
		$sql2 = mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer3', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer4', '0')")or die(mysql_error());
	...
	if($isCorrect == "answer4"){
		$sql2 = mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer4', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_v (question_id, answer, correct) VALUES ('$lastId', '$answer3', '0')")or die(mysql_error());
...
if(isset($_POST['reset']) && $_POST['reset'] != ""){
	...
	require_once("scripts/connect_db.php");
	mysql_query("TRUNCATE TABLE questions_v")or die(mysql_error());
	mysql_query("TRUNCATE TABLE answers_v")or die(mysql_error());
	$sql1 = mysql_query("SELECT id FROM questions_v LIMIT 1")or die(mysql_error());
	$sql2 = mysql_query("SELECT id FROM answers_v LIMIT 1")or die(mysql_error());
