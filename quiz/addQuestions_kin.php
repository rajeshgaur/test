...
if(isset($_POST['desc'])){
	...
	$sql = mysql_query("INSERT INTO questions_k (question, type) VALUES ('$question', '$type')")or die(mysql_error());
		$lastId = mysql_insert_id();
		mysql_query("UPDATE questions_k SET question_id='$lastId' WHERE id='$lastId' LIMIT 1")or die(mysql_error());
	$sqlq = mysql_query("INSERT INTO questions (question, type) VALUES ('$question', '$type')")or die(mysql_error());
		$lastIdq = mysql_insert_id();
		mysql_query("UPDATE questions SET question_id='$lastIdq' WHERE id='$lastIdq' LIMIT 1")or die(mysql_error());	
	//// Update answers based on which is correct //////////
	if($type == 'tf'){
		if($isCorrect == "answer1"){
		$sql2 = mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		$sqlq2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer2', '0')")or die(mysql_error());
		$msg = 'Thanks, your question has been added';
	  header('location: addQuestions_kin.php?msg='.$msg.'');
	exit();
	}
	if($isCorrect == "answer2"){
		$sql2 = mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer2', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysql_error());
		$sqlq2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer2', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer1', '0')")or die(mysql_error());
		$msg = 'Thanks, your question has been added';
	  header('location: addQuestions_kin.php?msg='.$msg.'');
	exit();
		}	
	...
	if($type == 'mc'){
		...
		$sql2 = mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer3', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer4', '0')")or die(mysql_error());
		$sqlq2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer1', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer3', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer4', '0')")or die(mysql_error());
		$msg = 'Thanks, your question has been added';
	  header('location: addQuestions_kin.php?msg='.$msg.'');
	exit();
	}
	...
	if($isCorrect == "answer3"){
		$sql2 = mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer3', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer4', '0')")or die(mysql_error());
		$sqlq2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer3', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer1', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer4', '0')")or die(mysql_error());
		$msg = 'Thanks, your question has been added';
	...
	if($isCorrect == "answer4"){
		$sql2 = mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer4', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers_k (question_id, answer, correct) VALUES ('$lastId', '$answer3', '0')")or die(mysql_error());
		$sqlq2 = mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer4', '1')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer1', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer2', '0')")or die(mysql_error());
		mysql_query("INSERT INTO answers (question_id, answer, correct) VALUES ('$lastIdq', '$answer3', '0')")or die(mysql_error());
		$msg = 'Thanks, your question has been added';
...
if(isset($_POST['reset']) && $_POST['reset'] != ""){
	...
	require_once("scripts/connect_db.php");
	mysql_query("TRUNCATE TABLE questions_k")or die(mysql_error());
	mysql_query("TRUNCATE TABLE answers_k")or die(mysql_error());
	$sql1 = mysql_query("SELECT id FROM questions_k LIMIT 1")or die(mysql_error());
	$sql2 = mysql_query("SELECT id FROM answers_k LIMIT 1")or die(mysql_error());
...
<body>
  ...
  <div class="content" id="tf">
  	<h3>True or false</h3>
    	<form action="addQuestions_kin.php" name="addQuestion" method="post">
 ...
 <div class="content" id="mc">
    ...
    <form action="addQuestions_kin.php" name="addMcQuestion" method="post">
    <strong>Please type your new question here</strong>
        <br />
