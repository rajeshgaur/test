...
<html>
	<head>
		...
		<link rel = "stylesheet" type = "text/css" href = "css/flatly.css">
            <script src="js/createjs.js">               
            </script>
            <script type="application/x-javascript" src = "js/jquery-1.10.2.js">
            </script>
            <script type = "text/javascript" src = "js/first-law.js"></script>
	...
	<body>
		...
		<div class="”container”" style = "font-family: 'Museo Slab'">
    		...
    		<div class="col-md-7" style = "margin-left: 10px; margin-top: 10px">
                <canvas id="demoCanvas" width="800" height="400" style = "background:url('img/city.jpg')">
        alternate content
    </canvas>
    		  </div>
    		</div>
